...
_samples = [
    {
        'url': 'http://kernel.org',
        'title': 'The Linux Kernel Homepage',
        'tags': ['linux', 'kernel'],
    },
    {
        'url': 'http://reddit.com',
        'title': 'The front page of the internet',
        'tags': ['reddit', 'social', 'news'],
    },
    {
        'url': 'http://news.ycombinator.com',
        'title': 'Hacker News',
        'tags': ['hackers', 'news', 'social'],
    },
    {
        'url': 'http://reddit.com/r/aww',
        'title': 'Things that make you go AWW!',
        'tags': ['reddit', 'social', 'aww', 'pics'],
    },
    {
        'url': 'https://reddit.com/r/programming',
        'title': 'r/programming',
        'tags': ['reddit', 'programming', 'development'],
    },
]
